...
int main() {
    ...
    iRobot R1("1.modelis","Right_sen",true, "Left_sen",false);// 1.robota nosaukums, kreisā sensora stāvoklis, labā sensorastāvoklis
    int room_R1[10] = {23, 35, 55, 74, 41, 43, 34, 77, 23, 98};// 1.robota room
    
    iRobot R2("2.modelis","Right_sen",true, "Left_sen",false);
    int room_R2[10] = {23, 35, 55, 74, 44, 47, 34, 77, 23, 98};
    
    
//    R1.LeftSensor.PrintSensor();
//    R1.RightSensor.PrintSensor();
